...
const Users = () => {
 ...
 const Borrar = async (endpoint,data) =>{
   ...
   try {
     const response = await fetch(`http://localhost:3031/puerto/borrar/${endpoint}`,{
       headers: {
      ...
      <div id="wrapper">
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div>
              <br/>
            <h1  className="text-nowrap-width: 8rem;">Puertos(Tarifas)</h1>
            
            <br/>
              <Link className="btn btn-primary" to="/Createpuerto">Añadir Puerto</Link>
            </div>
              {/* <!-- Page Heading --> */}
              ...
              <div className="table-responsive">
                        <table className="responsive-table  table-bordered ">
                            <thead>
                                ...
                                <tr>
                                    <th scope="col">Puerto 1</th>
                                    <th scope="col">Puerto 2</th>
                            ...
                            {listado.map(puerto => 
                                  ...
                                  <td><svg  type="button" onClick={() =>handleBorrar(puerto._id)} xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
